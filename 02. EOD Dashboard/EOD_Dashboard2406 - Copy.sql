...
select count(*) , sum(footused_tabco_ex_booklet) footused_tabco_ex_booklet, sum(footused_tabco_good_ex_booklet) footused_tabco_good_ex_booklet from dt_inovar_dev_stg.u_mat_sales_bookings_eod_dashboard_test
...
select  count(*) , sum(footused_tabco_ex_booklet) footused_tabco_ex_booklet, sum(footused_tabco_good_ex_booklet) footused_tabco_good_ex_booklet from dt_inovar_prod_edw.u_mat_sales_bookings_eod_dashboard 
where is_operations = 1
/*
